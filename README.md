...
Reasoning Models (LRMs), covering both training and inference techniques.  In
addition to listing the original works, this version of the README annotates
each paper with the dominant **institution** (preferring companies over
universities) and a link to the implementation if one is publicly available.
...
| **First Return, Entropy‑Eliciting Explore (FR3E)** | **ByteDance** | [arXiv](https://arxiv.org/pdf/2507.07017) | [HuggingFace](https://huggingface.co/FR3E-Bytedance) |
...
| **BAPO: Stabilizing Off‑Policy RL for LLMs via Balanced Policy Optimization with Adaptive Clipping** | **Shanghai Qiji Zhifeng Co., Ltd.** | [arXiv](https://arxiv.org/pdf/2510.18927) | [GitHub](https://github.com/WooooDyy/BAPO) |
| **Agentic Reinforced Policy Optimization (ARPO)** | **Kuaishou Technology** | [arXiv](https://arxiv.org/pdf/2507.19849) | [GitHub](https://github.com/dongguanting/ARPO) |
...
| **No Prompt Left Behind: Exploiting Zero‑Variance Prompts in LLM RL via Entropy‑Guided Advantage Shaping (RL‑ZVP)** | **Adobe Research** | [arXiv](https://arxiv.org/pdf/2509.21880) | – |
| **Right Question is Already Half the Answer: Fully Unsupervised LLM Reasoning Incentivization (EMPO)** | **Tencent AI Lab** | [arXiv](https://arxiv.org/pdf/2504.05812) | [GitHub](https://github.com/QingyangZhang/EMPO) |
...
| **Unlocking Exploration in RLVR: Uncertainty‑Aware Advantage Shaping for Deeper Reasoning (UCAS)** | **Kuaishou Technology** | [arXiv](https://arxiv.org/pdf/2510.10649) | [GitHub](https://github.com/xvolcano02/UCAS) |
| **Pinpointing Crucial Steps: Attribution‑Based Credit Assignment for Verifiable RL (ACPO)** | **Taikang Insurance Group Inc.** | [arXiv](https://arxiv.org/pdf/2510.08899) | – |
| **Conditional Advantage Estimation for RL in Large Reasoning Models (CANON)** | **Shanghai Jiao Tong University** | [arXiv](https://arxiv.org/pdf/2509.23962) | [GitHub](https://github.com/biuboomc/CANON) |
| **Quantile Advantage Estimation for Entropy‑Safe Reasoning (QAE)** | **University of Science and Technology of China** | [arXiv](https://arxiv.org/pdf/2509.22611) | [GitHub](https://github.com/junkangwu/QAE) |
...
| **Toward Better EHR Reasoning in LLMs: RL with Expert Attention Guidance (EAG‑RL)** | **Peking University** | [arXiv](https://arxiv.org/pdf/2508.13579) | [GitHub](https://github.com/devilran6/EAG-RL) |
| **Clip‑Low Increases Entropy and Clip‑High Decreases Entropy in RL of Large Language Models** | **KRAFTON** | [arXiv](https://arxiv.org/pdf/2509.26114) | – |
...
| **Stabilizing Knowledge, Promoting Reasoning: Dual‑Token Constraints for RLVR (Archer)** | **Kuaishou Technology** | [arXiv](https://arxiv.org/pdf/2507.15778) | [GitHub](https://github.com/wizard-III/ArcherCodeR) |
...
| Paper | Institution | PDF | Code |
|-------|-------------|-----|------|
| **The Invisible Leash? Why RLVR May or May Not Escape Its Origin** | **NVIDIA** | [arXiv](https://arxiv.org/pdf/2507.14843) | – |
| **DAPO: An Open‑Source LLM RL System at Scale** | **ByteDance** | [arXiv](https://arxiv.org/pdf/2503.14476) | [GitHub](https://github.com/BytedTsinghua-SIA/DAPO) |
| **From Trial‑and‑Error to Improvement: A Systematic Analysis of LLM Exploration Mechanisms in RLVR** | **Renmin University of China** | [arXiv](https://arxiv.org/pdf/2508.07534) | [GitHub](https://github.com/RUCAIBox/Slow_Thinking_with_LLMs) |
...
| **Efficient Multi‑Turn RL for GUI Agents via Decoupled Training and Adaptive Data Curation (DART‑GUI)** | **DataCanvas** | [arXiv](https://arxiv.org/pdf/2509.23866) | – |
...
| **The Entropy Mechanism of RL for Reasoning Language Models** | **Shanghai AI Laboratory** | [arXiv](https://arxiv.org/pdf/2505.22617) | [GitHub](https://github.com/PRIME-RL/Entropy-Mechanism-of-RL) |
| **Rethinking Entropy Interventions in RLVR: An Entropy Change Perspective (STEER)** | **Tencent** | [arXiv](https://arxiv.org/pdf/2510.10150) | [GitHub](https://github.com/zz-haooo/STEER) |
...
| Paper | Institution | PDF | Code |
|-------|-------------|-----|------|
| **Selective Expert Guidance for Effective and Diverse Exploration in RL of LLMs (MENTOR)** | **Ant Group** | [arXiv](https://arxiv.org/pdf/2510.04140) | [GitHub](https://github.com/Jiangzs1028/MENTOR) |
